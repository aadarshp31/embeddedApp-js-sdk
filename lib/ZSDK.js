...
var ZSDKMessageManager = (function(ZSDKMessageManager) {
  ...
  function MessageHandler(MessageEvent) {
    ...
    try {
      ...
      if(eventName === "__HANDSHAKE__"){
        let handShakeData = data.data;
        SDKContext.QueryParams = {...SDKContext.QueryParams, serviceOrigin : handShakeData.parentOrigin};
        let registrationMeta = SDKContext.getRegistrationMeta();
        RegisterApp(registrationMeta);
      } else if( eventName === 'SET_CONTEXT' || isAuthorizedMessage(MessageEvent)) {
        switch(messageType) {
...
;function ZSDK(options) { // TODO: Replace console with Logger
  ...
  function Bootstrap() {
    ...
    SDKContext.getRegistrationMeta = getRegistrationMeta;
